...
import { pokeReducer, ACTIONS } from '../logic/usePokemonReducer';
...
export const PokemonProvider = (props) => {
  ...
  const addPokemon = (pokemon) => () => {
    dispatch({type: ACTIONS.ADD_TO_CUSTOM_LIST, pokemon})
  };

  const removePokemon = (pokemon) => () => {
    dispatch({type: ACTIONS.REMOVE_FROM_CUSTOM_LIST, pokemon})
  };

  const addNewPokemon = (pokemon) => () => {
    dispatch({type: ACTIONS.ADD_NEW_POKEMON, pokemon})
  };
